...
const DotMaterial = shaderMaterial(
  {
    ...
    bgColor: new THREE.Color('#111827'),
    mouseTrail: null,
    render: 0,
    rotation: 0,
    gridSize: 50,
...
function Scene() {
  ...
  // Fix: Use React.useMemo to resolve potential JSX namespace conflicts.
  ...
  // Fix: Use React.useMemo to resolve potential JSX namespace conflicts.
  const dotMaterial = React.useMemo(() => {
    return new DotMaterial()
  }, [])

  // Fix: Use React.useEffect to resolve potential JSX namespace conflicts.
  React.useEffect(() => {
